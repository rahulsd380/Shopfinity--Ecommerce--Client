...
import NoProducts from "@/components/NoProducts/NoProducts"; // Import the NoProducts component
...
const RecentlyViewedProducts = () => {
  ...
  return (
    <Container>
      ...
      {products?.length > 0 ? ( // Conditional check for products
        ...
        <NoProducts /> // Render NoProducts if the products list is empty
      )}
    </Container>
  );
};

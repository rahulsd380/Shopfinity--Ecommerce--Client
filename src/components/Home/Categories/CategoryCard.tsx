...
const CategoryCard = ({category, bgColor}) => {
    return (
        <div className="w-[153px] p-4 text-center font-Inter rounded flex flex-col items-center transition-transform duration-300 ease-in-out hover:scale-105 hover:border hover:border-primary-10" style={{ backgroundColor: bgColor }}>
